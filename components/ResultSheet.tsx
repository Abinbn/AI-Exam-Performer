            ...
            <div className="bg-slate-50 p-6 h-[calc(100vh-80px)] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                <div className="space-y-8 pb-24">
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="bg-white p-6 rounded-lg shadow">
                            ...
                            <ul className="space-y-3">
                                {/* FIX: Use default empty array to prevent crash if strengths are missing */}
                        ...
                        <div className="bg-white p-6 rounded-lg shadow">
                            ...
                            <ul className="space-y-3">
                                {/* FIX: Use default empty array to prevent crash if weaknesses are missing */}
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        ...
                        <ul className="space-y-3">
                             {/* FIX: Use default empty array to prevent crash if recommendations are missing */}
